...
def load_preprocessor(saved_preprocessor_file: Optional[str] = None) -> nfp.MolPreprocessor:
    ...
    """
    preprocessor = nfp.MolPreprocessor(atom_features=atom_featurizer, bond_features=bond_featurizer)
