...
def run_stability(inputs, phase, B=None, out_file=None, phase_idx=-1):
    """
    ...
    phase_idx -- index of phase to check for stability
    ...
    # check if this compound matches the composition of the given phase
    cmpd = ''
    ...
    # if it does match, check if the phase is stable or unstable
    if len(borders) == 0:
        if cmpdnew == phasenew:
